...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (MLT, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up urgency-notice-insufficient) ==")
    ...
    (println "== filing/submit eng-4 (urgency-notice-insufficient -> HARD hold) ==")
