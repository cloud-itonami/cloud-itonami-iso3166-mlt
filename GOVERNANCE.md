...
`cloud-itonami-iso3166-mlt` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Malta-licensed counsel or a registered agent for whatever licensed
representation the law of Malta requires for public-procurement
filings.
